...
Once this has run a new Rstudio window will pop up containing the new project, along with the file structure and template scripts. 

The template scripts are labeled in order. For example 01_prepr.qmd through to XXX. 
