...
# convert the points datas to cleaned points to line segments
processed_transects <- make_lines(points = points,
...
# convert pt to lines (2 options here) with neighbours or without
