...
r25 <- create_template_raster(aoi, res = 25)
...
dem25 = get_cded_dem(aoi = fs::path(PEMprepr::read_fid()$dir_1020_covariates$path_abs, "25m", "template.tif"),
                   res = 25,
                   overwrite = TRUE)
...
# # need to update this once Prepr is merged. 

#find_saga_path()

#check_saga()

# note this is based on 25m resolution
