...
and [`PEMr`](https://github.com/ninoxconsulting/PEMr) on _GitHub_for details about the BC BEC classification system and, the PEM Project.
...
lapply(filestocopy, function(x) {
  file.copy(paste(origindir, x, sep = "/"),
    paste(targetdir, x, sep = "/"),
...
create_covariates(
  dtm = trim5, ## raster created above
